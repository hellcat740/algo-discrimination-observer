...
# 统计分析路由：/api/analysis/*（内部已挂 X-API-Key 鉴权依赖）
app.include_router(analysis_router)

# 演示数据管理路由：/api/admin/*（同样鉴权）
app.include_router(admin_router)

# 数据打包导出/导入路由：/api/export/bundle、/api/import/bundle（同样鉴权）
